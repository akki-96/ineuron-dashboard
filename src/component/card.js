  ...
  const usersDetailsHandler = () => {
    return (
      ...
      props.userList.map((item) => {
        ...
        const updatedAt = new Date(item.createdAt).toLocaleDateString();
        return (
          <div
            className="cards"
            key={item._id}
            onClick={() => props.handleUserDetails(item._id)}
          >
            <div>
              <img
                className="userIcon"
            ...
            <div>
              ...
              <div className="card-details">Created at: {createdAt}</div>
              <div className="card-details">Updated at: {updatedAt}</div>
            </div>
