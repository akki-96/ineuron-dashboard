  ...
  return (
    <div className="header">
      ...
      <div className="filter-container">
        ...
        <div className="filter-container">
          <div>
            <select onChange={(e) => props.handleFilter(e.target.value)} className="custom-select">
          ...
          <div>
            <select onChange={(e) => props.handleSorting(e.target.value)} className="custom-select">
